...
function Galeria() {
    ...
    useEffect(() => {
        const fetchVideos = async () => {
            try {
                const responseVideos = await fetch('https://alura-flix-api-nu.vercel.app/videos');
        ...
        const fetchCategorias = async () => {
            try {
                const responseCategorias = await fetch('https://alura-flix-api-nu.vercel.app/categoria');
